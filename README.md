...
Dockerfile for AWS Vault

## Quick Start

Here's how to get started...

1. `git clone https://github.com/UnionPOS/docker-aws-vault` to pull down the repository
...
Please use the [issue tracker](https://github.com/UnionPOS/docker-aws-vault/issues) to report any bugs or file feature requests.
